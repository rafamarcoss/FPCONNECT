...
\section{Página de Inicio y Autenticación}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/01_login_page.jpg}
  \caption{Página de login y registro de FPConnect con opciones de autenticación mediante Google y formulario personalizado}
  \label{fig:login_page}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/02_signup_form.jpg}
  \caption{Formulario de registro con selección de perfil (Alumno, Centro FP o Empresa)}
  \label{fig:signup_form}
\end{figure}

\section{Interfaz para Alumnos}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/03_noticias_fp.jpg}
  \caption{Sección de Noticias FP: becas, convocatorias y oportunidades para estudiantes de Formación Profesional}
  \label{fig:noticias_fp}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/04_feed_actividad.jpg}
  \caption{Feed de actividad reciente: publicaciones, comentarios y interacciones en la red social}
  \label{fig:feed_actividad}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/05_explorador_empresas.jpg}
  \caption{Explorador de empresas colaboradoras: búsqueda y filtrado por provincia, especialidad y sector}
  \label{fig:explorador_empresas}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/06_buscar_talento.jpg}
  \caption{Búsqueda de otros alumnos para conectar en red, filtrados por ciclo, especialidad y ubicación}
  \label{fig:buscar_talento}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/07_conexiones_alumnos.jpg}
  \caption{Panel de conexiones de alumno: gestión de solicitudes de conexión y red de contactos}
  \label{fig:conexiones_alumnos}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/08_ofertas_empleo.jpg}
  \caption{Sección de Ofertas de Empleo y Prácticas: publicadas por empresas para estudiantes de FP}
  \label{fig:ofertas_empleo}
\end{figure}

\section{Interfaz para Empresas}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/09_empresa_bienvenida.jpg}
  \caption{Página de bienvenida para empresas con actividad reciente y conexiones}
  \label{fig:empresa_bienvenida}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/10_empresa_crear_oferta.jpg}
  \caption{Formulario para crear nuevas ofertas de empleo y prácticas indicando puesto, ubicación y salario}
  \label{fig:empresa_crear_oferta}
\end{figure}

\section{Interfaz para Centros Educativos}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/11_centro_bienvenida.jpg}
  \caption{Página de bienvenida para centros FP con información de actividad reciente}
  \label{fig:centro_bienvenida}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/12_alumnos_vinculados.jpg}
  \caption{Panel de alumnos vinculados al centro: gestión de estudiantes y búsqueda en la red}
  \label{fig:alumnos_vinculados}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/13_explorador_centros.jpg}
  \caption{Explorador de centros educativos: búsqueda por provincia, grado y especialización}
  \label{fig:explorador_centros}
\end{figure}
